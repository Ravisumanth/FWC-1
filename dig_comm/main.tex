...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/two_dice.pdf}
\caption{Plot of $p_X(n)$.  Simulations are close to the analysis. }
\label{fig:dice}
\end{figure}
\item The python code is available in 
\begin{lstlisting}
dig_comm/Two_dice/twodice.py
\end{lstlisting}
...
\begin{lstlisting}
dig_comm/include/coeffs.h
dig_comm/Random_Numbers/uniform_stat.c
\end{lstlisting}
...
\begin{lstlisting}
dig_comm/Random_Numbers/uniform_cdf.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/uniform_cdf.pdf}
...
\begin{lstlisting}
dig_comm/include/coeffs.h
dig_comm/Random_Numbers/gaussian_stat.c
\end{lstlisting}
%
\item
Load gau.dat in python and plot the empirical CDF of $X$ using the samples in gau.dat. What properties does a CDF have?
\\
\solution The CDF of $X$ is plotted in \figref{fig:gauss_cdf} using below code
\begin{lstlisting}
dig_comm/Random_Numbers/gaussian_cdf_pdf.py
\end{lstlisting}
...
\begin{lstlisting}
dig_comm/Random_Numbers/log_func_cdf.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/log_func_cdf.pdf}
...
\begin{lstlisting}
dig_comm/include/coeffs.h
dig_comm/Random_Numbers/sumofrv_stat.c
\end{lstlisting}
\item Find the CDF of $T$.\\
\solution Loading the samples from uni1.dat and uni2.dat in python, the CDF is plotted in \figref{fig:tri_cdf} using the below code

\begin{lstlisting}
dig_comm/Random_Numbers/sumofrv_cdf_pdf.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/sumofrv_cdf.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/sumofrv_pdf.pdf}
...
\begin{lstlisting}
dig_comm/BPSK/bpsk.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/bpsk_scatter.pdf}
...
\begin{lstlisting}
dig_comm/BPSK/condprob_vs_snr.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/bpsk_snr.pdf}
...
\solution
Maximum A Posteriori (MAP) criterion is an estimate to find $x$ such that $p_X|Y(x|y)$ is maximum. 
...
\item The python code is available in 
\begin{lstlisting}
dig_comm/BPSK/map_bpsk.py
\end{lstlisting}

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/bpsk_map.pdf}
...
\begin{lstlisting}
dig_comm/rv_trans/sumofsq_stats.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/sos_cdf.pdf}
\caption{CDF of $V$}
\label{fig:chisq_cdf}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/sos_pdf.pdf}
\caption{PDF of $V$}
\label{fig:chisq_pdf}
\end{figure}
%
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/square_root_cdf.pdf}
\caption{CDF of $A$}
\label{fig:rayleigh_cdf}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/square_root_pdf.pdf}
\caption{PDF of $A$}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/rayleigh.pdf}
...
\begin{lstlisting}
dig_comm/FSK/fsk_scatter.py
\end{lstlisting}
%
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/fsk.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{./figs/fsk_snr.pdf}
